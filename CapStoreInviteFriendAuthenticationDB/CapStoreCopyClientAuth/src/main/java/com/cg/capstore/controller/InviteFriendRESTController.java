...
public class InviteFriendRESTController {
	...
	public ModelMap sendInvitation(String customerName, String friendEmail, ModelMap map) throws MessagingException {
		System.err.println("IN JSP REST CONTROLLER");
		System.err.println(customerName+"   "+friendEmail);
		...
		String result="Success!!! <br/> Invitation Has been sent to your friend "+reply.get("friendEmail");
